        ...
        <section className="container mx-auto relative overflow-hidden bg-black py-10 text-white">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-6">
                ...
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <motion.p className="font-bold text-orange-400"
                        animate={{ scale: [1, 2, 1] }}
                        transition={{
                            duration: 1.5,
                            repeat: Infinity,
                    ...
                    <motion.p className="font-bold text-blue-400"
                        animate={{ scale: [2, 1, 2] }}
                        transition={{
                            duration: 1.5,
                            repeat: Infinity,
                ...
                <div className="mt-20 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    {stats.map((stat) => (
                        <div
                            key={stat.id}
                            className="group relative overflow-hidden rounded-3xl border border-white/10 bg-white/3 p-8 backdrop-blur-xl transition duration-300 hover:border-violet-500/70">
                            {/* Card Glow */}
