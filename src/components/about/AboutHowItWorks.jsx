        ...
        <section className="bg-zinc-950 px-6 py-24">
            <div className="mx-auto max-w-7xl">
                ...
                <div className="relative mt-16 grid gap-8 md:grid-cols-4">
                    ...
                    {/* Connecting Line */}
                    <div className="absolute left-[12%] right-[12%] top-8 hidden h-px bg-zinc-800 md:block" />
                    ...
                    {steps.map((step, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className="relative mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-indigo-500/30 bg-zinc-900 text-indigo-400">
                                    <Icon size={24} />
                                </div>

                                <span className="mt-5 block text-xs font-bold tracking-widest text-indigo-400">
                                    {step.number}
                                </span>
