...
export default function PostJobForm({ company }) {
    ...
    return (
        <div className="min-h-screen bg-[#0d0d0e] text-white px-4 ">
                ...
                <Form onSubmit={handleSubmit} className="space-y-8" validationErrors={errors} validationBehavior='aria'>
                    ...
                    <Fieldset className="space-y-6 w-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <Select aria-label="Job Category" className={selectBoxClass} name="jobCategory" isInvalid={!!errors.jobCategory}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <Select aria-label="Job Type" className={selectBoxClass} name="jobType" isInvalid={!!errors.jobType}>
                            ...
                            <div className="grid grid-cols-3 gap-2">
                                <div className="col-span-2 space-y-1">
                                    ...
                                    <div className="flex gap-2">
                                        <TextField aria-label="Minimum Salary" name="minSalary" isInvalid={!!errors.minSalary} className="w-full">
                                            <Input placeholder="Min" type="number" className={textInputClass} />
                                        </TextField>
                                        <TextField aria-label="Maximum Salary" name="maxSalary" isInvalid={!!errors.maxSalary} className="w-full">
                                            <Input placeholder="Max" type="number" className={textInputClass} />
                                        </TextField>
                                    </div>
                                </div>

                                <Select aria-label="Currency" className="w-full mt-6" name="currency" defaultSelectedKeys={["USD"]}>
                                    <Select.Trigger className={triggerClasses}>
                                        <Select.Value />
                                        <Select.Indicator />
                                    </Select.Trigger>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                            <div className="space-y-2">
                                ...
                                <TextField aria-label="Location" name="location" isInvalid={!isRemote && !!errors.location} className="flex flex-col gap-1 w-full relative">
                            ...
                            <TextField aria-label="Application Deadline" name="deadline" isInvalid={!!errors.deadline} className="flex flex-col gap-1 w-full">
                                <Label className="text-zinc-400 font-medium text-sm">Application Deadline</Label>
                                <Input aria-label="Application Deadline" type="date" className={textInputClass} />
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t border-zinc-800 w-full">
                        <Button type="button" variant="bordered" className="border-zinc-800 text-zinc-300 hover:bg-zinc-900 rounded-lg px-6 font-medium h-11"> Cancel</Button>
                        <Button
                            type="submit"
