    ...
    return (
        <div className="w-full min-h-screen bg-slate-50 dark:bg-zinc-950 p-6 md:p-12 text-slate-900 dark:text-white transition-colors duration-300">
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                {/* Counter Skeleton */}
                <div className="h-4 w-32 bg-slate-200 dark:bg-zinc-900 rounded" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[1, 2, 3, 4, 5, 6].map((item) => (
                        <div
                            key={item}
                            className="h-64 w-full rounded-2xl border border-slate-200 dark:border-zinc-800/80 bg-white dark:bg-zinc-900/40 p-6 flex flex-col justify-between animate-pulse shadow-sm dark:shadow-none transition-colors">
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="h-3 w-20 bg-slate-200/60 dark:bg-zinc-800/60 rounded" />
                                    </div>
                                </div>
                                <div className="h-4 w-3/4 bg-slate-200/60 dark:bg-zinc-800/60 rounded mt-4" />
                            </div>

                            <div className="flex justify-between items-center pt-4 border-t border-slate-100 dark:border-zinc-800/60">
                                <div className="h-6 w-20 bg-slate-200/60 dark:bg-zinc-800/60 rounded-full" />
